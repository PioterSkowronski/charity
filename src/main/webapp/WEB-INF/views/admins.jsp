...
<header class="header--form-page">
    <nav class="container container--70">
        ...
        <ul>
            <li><a href="<c:url value="/"/>" class="btn btn--without-border active">Strona główna</a></li>
            <li><a href="<c:url value="/admin/institutions"/>" class="btn btn--without-border">Instytucje</a></li>
