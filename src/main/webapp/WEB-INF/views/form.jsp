...
<form:form method="post"
    ...
    <form:checkboxes itemValue="id" itemLabel="name" path="categories"
                     items="${categories}"/>
    <form:select itemValue="id" itemLabel="name" path="institution" items="${institutions}"/>
    ...
    <form:input path="quantity" placeholder="Liczba worków"/>
