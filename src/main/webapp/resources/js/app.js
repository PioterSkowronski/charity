        ...
        updateForm() {
            ...
            function getRadioValue(form, name) {
                ...
                for (let i = 0; i < radios.length; i++) {
                    if (radios[i].checked) {
                        institution = radios[i].placeholder;
                    }
                }
                return institution;
            }
            ...
            document.getElementById('summary-institution').innerHTML = 'Dla organizacji ' + getRadioValue(document.getElementById('donation'), 'institution');
